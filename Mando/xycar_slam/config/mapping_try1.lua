...
TRAJECTORY_BUILDER_2D.max_range = 18.
...
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_length = 0.2
...
TRAJECTORY_BUILDER_2D.submaps.range_data_inserter.probability_grid_range_data_inserter.hit_probability = 1.0
